...
namespace YouTubeSearch.Standard
{
    ...
    public sealed class YouTubeSearchClient : IConfiguration
    {
        ...
        /// <summary>
        /// Gets YoutubeController controller.
        /// </summary>
        public YoutubeController YoutubeController => this.youtube.Value;
        ...
        internal static YouTubeSearchClient CreateFromEnvironment()
        {
            ...
            string accessToken = System.Environment.GetEnvironmentVariable("YOU_TUBE_SEARCH_STANDARD_ACCESS_TOKEN");
